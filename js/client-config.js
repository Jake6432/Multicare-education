 ...
 *   2. Update the values below — especially clientId
 ...
 *   general.multicarelearning.ca  → clientId: "general"
 *   acme.multicarelearning.ca     → clientId: "acme"
 *   globex.multicarelearning.ca   → clientId: "globex"
 *
 * ALL SITES SHARE ONE GA4 PROPERTY.
 * The clientId field tags every analytics event so you can
 * filter by client in GA4 or build per-client Looker Studio
 * dashboards — all from one login.
 * ─────────────────────────────────────────────────────────────
 */
...
const CLIENT_CONFIG = {
  ...
  // ── Identity ──────────────────────────────────────────────
  clientId:         "general",                     // SHORT unique ID — used in analytics. e.g. "acme", "wildbrain", "colas"
  ...
  // ── Capsule visibility ────────────────────────────────────
  // Set to false to hide a category for this client.
  showCategories: {
    core:    true,
    invest:  true,
    life:    true,
  ...
  // ── Analytics ─────────────────────────────────────────────
  // ONE shared GA4 property for all clients.
  // All events are tagged with clientId above so you can
  // filter per client in GA4 and Looker Studio.
  // Format: "G-XXXXXXXXXX"
  ga4MeasurementId: "",

  // Plausible domain (optional — simpler dashboard, free for one domain)
  // Format: "multicarelearning.ca" — no https://, no trailing slash
  plausibleDomain: "multicare-learning.netlify.app",

  // ── Colours (optional client brand overrides) ─────────────
  // Leave blank to use MultiCare default navy/teal palette.
  brandNavy: "",
  brandTeal: "",
  brandGold: "",

  // ── Manulife member portal ────────────────────────────────
